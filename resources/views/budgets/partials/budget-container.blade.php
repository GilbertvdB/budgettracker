<div class="w-full bg-white rounded-xl shadow-lg p-4 mb-4 {{ $budget->active == 0 ? 'opacity-50' : '' }}">
    ...
    @if($budget->shared_users_email)
        <span>{{ $budget->shared_users_email }}</span>
    @else
        <a href="{{ route('budgets.shareBudget', $budget)}}">Share</a>
    @endif
</div>